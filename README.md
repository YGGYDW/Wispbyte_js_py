...
```
curl -Ls https://raw.githubusercontent.com/YGGYDW/Wispbyte_js_py/refs/heads/main/hy2.sh | sed 's/\r$//' | bash
```
...
```
curl -Ls https://raw.githubusercontent.com/YGGYDW/Wispbyte_js_py/refs/heads/main/tuic.sh | sed 's/\r$//' | bash
```
